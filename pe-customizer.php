...
function pe_customize_controls_scripts()
{
    ...
    wp_enqueue_script('pe-customize-controls', get_theme_file_uri('/customizer/assets/js/pe-customize-controls.js'), array(), '1.0', true);
...
function pe_customize_controls_styles()
{
    ...
    wp_enqueue_style('pe-customize-controls', get_theme_file_uri('/customizer/assets/css/pe-customize-controls.css'), array(), '1.0');
